...
#  21. Создать переменную div_int, в которой разделите int_item на 2
div_int = int_item / 2
...
#  23. Создать переменную item_1, в которой прибавьте 10 к переменной int_item
item_1 = int_item + 10
...
if currency_convertor:
    ...
    if target_currency == "eur":
        ...
        currency_result = float(target_currency_amount) / usd_usd_rate
